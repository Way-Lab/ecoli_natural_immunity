...
# Uses N2SKTQ_1_1 as the reference genome
# Includes all 12 N2SKTQ strains (N2SKTQ_1_1 through N2SKTQ_12_12) plus 6 Z6M7Y5 isolates
...
OUTPUT_DIR="Z6M7Y5_comparative_analysis"

echo "=========================================="
echo "Z6M7Y5 + N2SKTQ Comparative Analysis"
echo "=========================================="
...
TOTAL_GENOMES=$((N2SKTQ_COUNT + Z6M7Y5_COUNT + 1))
echo ""
...
vcf_file = "Z6M7Y5_comparative_analysis/parsnp_results/parsnp.vcf"
output_file = "Z6M7Y5_comparative_analysis/parsnp_results/snp_distance_matrix.tsv"
...
if [ -f "${OUTPUT_DIR}/parsnp_results/snp_distance_matrix.tsv" ]; then
    ...
    echo "--------------------"
    column -t -s $'\t' ${OUTPUT_DIR}/parsnp_results/snp_distance_matrix.tsv
    echo ""
fi
