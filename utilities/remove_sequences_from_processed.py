...
# Read the processed file and filter out unwanted sequences
input_file = 'OmpA_peptide_sequences_processed.fasta'
output_file = 'OmpA_peptide_sequences_processed_filtered.fasta'
