...
# --- run_snippy_nissle_refseq.sh ---
# Snippy variant calling and core SNP analysis using Nissle RefSeq reference
# Runs snippy on reads against Nissle reference, then snippy-core for core genome SNPs
...
# Reference genome (Nissle RefSeq)
...
# Output directory
OUTPUT_DIR="snippy_results_nissle_refseq"
...
echo "============================================"
echo "   Snippy Core SNP Analysis - Nissle RefSeq"
echo "============================================"
...
echo "Step 1: Running snippy on each sample against Nissle RefSeq..."
echo ""
