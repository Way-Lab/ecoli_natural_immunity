#!/usr/bin/env python3
"""
Create a comprehensive summary of SNPs by sample with gene annotations.
"""
...
def main():
    # Load annotated SNPs
    df = pd.read_csv('comprehensive_parsnp_analysis/parsnp_output/snps_annotated.tsv', sep='\t')

    # Create output file
    output_file = 'comprehensive_parsnp_analysis/parsnp_output/snp_summary_by_sample.txt'

    with open(output_file, 'w') as f:
        f.write('='*100 + '\n')
        f.write('COMPREHENSIVE SNP ANALYSIS - SNPs by Sample with Gene Annotations\n')
    ...
    print()
    print('='*100)
    print('COMPREHENSIVE SNP ANALYSIS - SNPs by Sample with Gene Annotations')
